                                                                              ...
                                                                              showDialog(
                                                                                  ...
                                                                                  builder: ((context) {
                                                                                    return MessageDialog(
                                                                                        content: Text('Do you want to report this users?', style: GoogleFonts.aBeeZee(fontSize: 14, fontWeight: FontWeight.w600, color: Theme.of(context).secondaryHeaderColor)),
                                                                        ...
                                                                        InkWell(
                                                                            onTap:
                                                                              ...
                                                                              showDialog(
                                                                                  ...
                                                                                  builder: (context) {
                                                                                    return MessageDialog(
                                                                                        content: Text('Do you want to block this member?', style: GoogleFonts.aBeeZee(fontSize: 14, fontWeight: FontWeight.w600, color: Theme.of(context).secondaryHeaderColor)),
                                                                            ...
                                                                            child:
                                                                                ListTile(leading: Icon(Icons.block, color: Theme.of(context).primaryColor, size: 30), title: Text('Block', style: GoogleFonts.aBeeZee(fontSize: 30, fontWeight: FontWeight.w600, color: Theme.of(context).primaryColor)))),
                                                                        const SizedBox(
                                                                            height:
                                                                                30),
                                                                        Column(
                                                                            children: [
                                                                              ElevatedButton(
                                                                                  ...
                                                                                  style: ElevatedButton.styleFrom(backgroundColor: Theme.of(context).backgroundColor, padding: const EdgeInsets.symmetric(horizontal: 50, vertical: 15), textStyle: TextStyle(color: Theme.of(context).secondaryHeaderColor, fontSize: 20, fontWeight: FontWeight.bold)),
